  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      for (let i in parseSearchArr) {
        if(parseSearchArr[i] === 'dog') queryString = queryString + (queryString !== '' ? '&category=D' : 'category=D')
        else if(parseSearchArr[i] === 'cat') queryString = queryString + (queryString !== '' ? '&category=C' : 'category=C')
        else if(parseSearchArr[i] === 'other') queryString = queryString + (queryString !== '' ? '&category=O' : 'category=O')
        else if(parseSearchArr[i] === 'small') queryString = queryString + (queryString !== '' ? '&size=S' : 'size=S')
        else if(parseSearchArr[i] === 'medium') queryString = queryString + (queryString !== '' ? '&size=M' : 'size=M')
        else if(parseSearchArr[i] === 'large') queryString = queryString + (queryString !== '' ? '&size=L' : 'size=L')
        else if(parseSearchArr[i] === 'male') queryString = queryString + (queryString !== '' ? '&gender=M' : 'gender=M')
        else if(parseSearchArr[i] === 'female') queryString = queryString + (queryString !== '' ? '&gender=L' : 'gender=L')
        else if(parseSearchArr[i] === 'available') queryString = queryString + (queryString !== '' ? '&status=AV' : 'status=AV')
        else if(parseSearchArr[i] === 'adopted') queryString = queryString + (queryString !== '' ? '&status=AD' : 'status=AD')
        else if(parseSearchArr[i] === 'pending') queryString = queryString + (queryString !== '' ? '&status=PE' : 'status=PE')
        else if(parseSearchArr[i] === 'withdrawn') queryString = queryString + (queryString !== '' ? '&status=WI' : 'status=WI')
